...
Class Master extends DBConnection {
	...
	function save_category(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Thêm mới danh mục thành công!");
			else
				$this->settings->set_flashdata('success',"Cập nhật danh mục thành công!");
		}else{
			$resp['status'] = 'failed';
	...
	function save_sub_category(){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Thêm mới danh mục phụ thành công!");
			else
				$this->settings->set_flashdata('success',"Cập nhật danh mục phụ thành công!");
		}else{
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error."[{$sql}]";
		}
	...
	function delete_sub_category(){
		...
		if($del){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Xóa danh mục phụ thành công");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function save_book(){
		...
		if($save){
			...
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Thêm mới sách thành công");
			else
				$this->settings->set_flashdata('success',"Cập nhật sách thành công");
		}else{
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error."[{$sql}]";
		}
	...
	function delete_book(){
		...
		if($del){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Xóa sách thành công");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function save_inventory(){
		...
		if($check > 0){
			$resp['status'] = 'failed';
			$resp['msg'] = "Trong kho đã tồn tại loại sách này!";
			return json_encode($resp);
			exit;
		}
		if(empty($id)){
		...
		if($save){
			$resp['status'] = 'success';
			if(empty($id))
				$this->settings->set_flashdata('success',"Thêm mới đầu mục sách thành công!");
			else
				$this->settings->set_flashdata('success',"Cập nhật đầu mục sách thành công!");
		}else{
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error."[{$sql}]";
		}
	...
	function delete_inventory(){
		...
		if($del){
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success',"Xóa đầu mục sách thành công!");
		}else{
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
