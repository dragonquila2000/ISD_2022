    ...
    <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="m-0"><small>Tác giả: <?php echo $row['author']?></small></p>
        ...
        <div class="row">
            <div class="col-6">
                ...
                <p>Tình trạng thanh toán: <?php echo $paid == 0 ? '<span class="badge badge-light text-dark">Chưa trả tiền</span>' : '<span class="badge badge-success">Đã trả tiền</span>' ?></p>
                <p>Phương thức nhận hàng: <?php echo $order_type == 1 ? '<span class="badge badge-light text-dark">Giao hàng tận nơi</span>' : '<span class="badge badge-light text-dark">Nhận tại cửa hàng</span>' ?></p>
            </div>
            <div class="col-6 row row-cols-2">
                ...
                <?php 
                    switch($status){
	                    ...
	                    break;
                        case '3':
                            echo '<span class="badge badge-success">Đã đến nơi</span>';
	                    break;
                        case '5':
                            echo '<span class="badge badge-success">Picked Up</span>';
	                    break;
                        default:
                            echo '<span class="badge badge-danger">Đơn hàng hủy</span>';
	                    break;
                    }
                ?>
                </div>
