...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Cập nhật thông tin ": "Thêm mới " ?> sách</h3>
	</div>
	<div class="card-body">
		<form action="" id="product-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
            <div class="form-group">
				<label for="category_id" class="control-label">Danh mục chính</label>
            ...
            <div class="form-group">
				<label for="sub_category_id" class="control-label">Danh mục phụ</label>
                <select name="sub_category_id" id="sub_category_id" class="custom-select" required>
                <option value="" selected="" disabled="">Vui lòng chọn danh mục chính trước</option>
                <?php
			...
			<div class="form-group">
				<label for="title" class="control-label">Tựa đề</label>
            ...
            <div class="form-group">
				<label for="" class="control-label">Ảnh minh họa</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="product-form">Lưu thông tin</button>
...
<script>
	...
	$(document).ready(function(){
        $('.rem_img').click(function(){
            _conf("Bạn có chắc chắn muốn xóa ảnh?",'delete_img',["'"+$(this).attr('data-path')+"'"])
        })
        ...
        $('#category_id').change(function(){
            ...
            $('#sub_category_id').select2({placeholder:"Vui lòng chọn theo danh mục dưới đây",width:"relative"})
        })
        $('.select2').select2({placeholder:"Vui lòng chọn theo danh mục dưới đây",width:"relative"})
