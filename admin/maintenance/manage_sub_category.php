...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Cập nhật thông tin ": "Thêm mới " ?> Danh mục phụ</h3>
	</div>
	<div class="card-body">
		<form action="" id="category-form">
			...
			<div class="form-group">
				<label for="sub_category" class="control-label">Tên danh mục phụ</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="category-form">Lưu thông tin</button>
...
<script>
	...
	$(document).ready(function(){
        $('.select2').select2({placeholder:"Vui lòng chọn tại dây",width:"relative"})
