    ...
    <div class="card-body">
        <form id="filter-form">
            <div class="row align-items-end">
                ...
                <div class="form-group col-md-3">
                    <label for="date_start">Đến ngày</label>
        ...
        <div id="printable">
            <div>
                ...
                <h3 class="text-center m-0"><b>Thống kê doanh thu</b></h3>
                <p class="text-center m-0">Trong thời gian từ ngày <?php echo $date_start ?> đến ngày <?php echo $date_end ?></p>
                <hr>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="m-0"><small>Tác giả: <?php echo $roww['author'] ?></small></p>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="text-center" colspan="6">Không có thông tin</td>
                    </tr>
                    <?php endif; ?>
                </tbody>
            </table>
