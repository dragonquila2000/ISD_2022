	...
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="short_name" class="control-label">Tên vắn tắt</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Chính sách bảo mật</label>
		...
		<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary" form="system-frm">Cập nhật thông tin</button>
				</div>
			</div>
		</div>
