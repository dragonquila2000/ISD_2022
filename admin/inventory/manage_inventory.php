...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Cập nhật ": "Thêm mới " ?> kho sách</h3>
	</div>
	<div class="card-body">
		<form action="" id="inventory-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group">
				<label for="product_id" class="control-label">Sách</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="inventory-form">Lưu thông tin</button>
