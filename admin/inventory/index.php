...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Kho sách</h3>
		<div class="card-tools">
			<a href="?page=inventory/manage_inventory" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>Thêm mới sách</a>
		</div>
	</div>
	<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td>
								<p class="m-0"><small><b>Tựa đề:</b> <?php echo $row['product'] ?></small></p>
								<p class="m-0 truncate"><b>Tác giả:</b> <?php echo $row['author'] ?></p>
							</td>
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="?page=inventory/manage_inventory&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span>Sửa thông tin</a>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Bạn có chắc chắn muốn xóa danh mục này không?","delete_inventory",[$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
