...
<aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand">
  ...
  <a href="<?php echo base_url ?>admin" class="brand-link bg-primary text-sm">
    <img src="<?php echo validate_image($_settings->info('logo')) ?>" alt="Store Logo" class="brand-image elevation-3" style="opacity: .8;width: 2.7rem;height: 2.7rem;max-height: unset">
