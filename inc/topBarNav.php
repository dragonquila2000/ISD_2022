<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid px-4 px-lg-5 ">
        ...
        <a class="navbar-brand" href="./">
            <img src="
            <?php echo validate_image($_settings->info('logo')) ?>" width="40" height="40" class="d-inline-block align-top" alt="" loading="lazy">
        ...
        <form class="form-inline" id="search-form">
            <div class="input-group">
                <input class="form-control form-control-sm form " type="search" placeholder="Tìm kiếm sản phẩm ..." aria-label="Search" name="search" value="<?php echo isset($_GET['search']) ? $_GET['search'] : "" ?>" aria-describedby="button-addon2">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                ...
                <?php
                $cat_qry = $conn->query("SELECT * FROM categories where status = 1  limit 0");
                ...
                ?>
                        <li class="nav-item"><a class="nav-link" aria-current="page" href="./?p=products&c=<?php echo md5($crow['id']) ?>"><?php echo $crow['category'] ?></a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu  p-0" aria-labelledby="navbarDropdown<?php echo $crow['id'] ?>">
                                <?php while ($srow = $sub_qry->fetch_assoc()) : ?>
                                    <li><a class="dropdown-item border-bottom" href="./?p=products&c=<?php echo md5($crow['id']) ?>&s=<?php echo md5($srow['id']) ?>"><?php echo $srow['sub_category'] ?></a>
                                    </li>
                                <?php endwhile; ?>
                            </ul>
                        </li>
                ...
                <?php endif; ?>
                <li class="nav-item"><a class="nav-link" href="./?p=news">Tin tức</a></li>
                <li class="nav-item"><a class="nav-link" href="./?p=discount">Ưu đãi</a></li>
                <li class="nav-item"><a class="nav-link" href="./?p=about">Về chúng tôi</a></li>
            </ul>
            <div class="d-flex align-items-center">
                ...
                <?php else : ?>
                    ...
                    <a href="./?p=my_account" class="text-dark  nav-link"><b><?php echo $_settings->userdata('lastname') ?>!</b></a>
