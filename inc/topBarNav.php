<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid px-4 px-lg-5 ">
        ...
        <a class="navbar-brand" href="./">
            <!--                <img src="-->
            <?php //echo validate_image($_settings->info('logo')) ?><!--" width="30" height="30" class="d-inline-block align-top" alt="" loading="lazy">-->
            <?php echo $_settings->info('short_name') ?>
        </a>

        <form class="form-inline" id="search-form">
            <div class="input-group">
                <input class="form-control form-control-sm form " type="search" placeholder="Tìm kiếm sản phẩm ..."
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                ...
                <?php
                $cat_qry = $conn->query("SELECT * FROM categories where status = 1  limit 2");
            ...
            <div class="d-flex align-items-center">
                ...
                <?php else: ?>
                    ...
                    <a href="./?p=my_account"
                       class="text-dark  nav-link"><b><?php echo $_settings->userdata('lastname') ?>!</b></a>
