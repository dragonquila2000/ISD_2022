    ...
    <div class="container">
        <div class="row">
            <div class="col d-flex justify-content-end mb-2">
                <button class="btn btn-outline-dark btn-flat btn-sm" type="button" id="empty_cart">Reset giỏ hàng</button>
            </div>
        </div>
        <div class="card rounded-0">
            <div class="card-body">
                ...
                ?>
                    <div class="d-flex w-100 justify-content-between  mb-2 py-2 border-bottom cart-item">
                        <div class="d-flex align-items-center col-8">
                            <span class="mr-2"><a href="javascript:void(0)" class="btn btn-sm rem_item" data-id="<?php echo $row['id'] ?>"><i class="fa fa-trash"></i></a></span>
                ...
                <div class="d-flex w-100 justify-content-between mb-2 py-2 border-bottom">
                    <div class="col-8 d-flex justify-content-end"><h4>Tổng cộng:</h4></div>
...
<script>
    ...
    $(function(){
        ...
        $('#empty_cart').click(function(){
            // empty_cart()
            _conf("Bạn có chắc chắn muốn reset toàn bộ giỏ hàng?",'empty_cart',[])
        })
        $('.rem_item').click(function(){
            _conf("Bạn có chắc chắn muốn xóa sản phẩm này?",'rem_item',[$(this).attr('data-id')])
        })
    })
</script>